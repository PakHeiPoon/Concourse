...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'home.pillar1.body': 'Every merchant anchored on Base via ERC-8004. Identity is verifiable, portable, sovereign — no platform can de-list you.',
    ...
    'profile.wallet.viewChainscan': 'View on Basescan',
    ...
    'detail.badge.verified': 'Verified on Base',
    ...
    'detail.viewRegisterTx': 'View register tx on Basescan',
    'detail.onchain.footer': 'Anchored on Base Sepolia (chainId 84532) via the ERC-8004 IdentityRegistry contract.',
    'detail.testSkills': 'Test these skills →',

    // ─── AgentDemo page (main hero only) ───
    'demoPage.title': 'Personal Agent Demo',
    'demoPage.subtitle': 'Bring your own API key to run the AI agent on Qiniu AIGC models.',
    ...
    'register.almostTitle.desc': 'Your profile data will be hashed and stored on Base. You need to sign the transaction with your Web3 wallet.',
    ...
    'register.submit': 'Register on Base',
    ...
    'register.success.desc': 'Your business profile has been anchored to Base.',
    'register.success.did': 'Your On-Chain DID',
    'register.success.hash': 'Profile Hash (SHA-256)',
    'register.success.tx': 'On-Chain Transaction',
    'register.success.viewExplorer': 'View on Basescan',
    'register.success.endpoint': 'Skill Endpoint',
    'register.success.again': 'Register Another Business',

    // ─── Agent demo page (chat UI) ───
    'demo.connectTitle': 'Connect to Qiniu AIGC',
    'demo.connectBadge': 'Connected to Qiniu · {network}',
    'demo.agentName': 'Concourse AI Agent',
    'demo.agentStatus.ready': 'Qiniu · {model}',
    'demo.agentStatus.notConnected': 'Not Connected',
    'demo.empty.title': 'Add your API key to start',
    'demo.empty.subtitle': 'Your Qiniu API key powers the AI inference',
    // Provider label (Qiniu API key)
    'demo.provider.zerog': 'Qiniu AIGC',
    ...
    'demo.greeting': "Hello! I'm your AI travel assistant powered by **Qiniu AIGC** and the **Concourse** decentralized registry.",
    ...
    'demo.connect.desc': 'Bring your own Qiniu API key — pick any model from the marketplace.',
    ...
    'demo.footer.poweredBy': 'Powered by Qiniu · {model}',
    ...
    'demo.footer.ready': 'Each message calls your selected Qiniu model.',
    'demo.footer.notReady': 'Add your Qiniu API key to power the AI agent',
    'demo.logs.title': 'Agent Execution Logs',
    'demo.logs.connected': 'Connected',
    ...
    'sign.subtitle': 'Your AI agent has prepared a merchant listing. Review it below, then connect your wallet to sign and anchor it on Base. Signing once gives your agent permission to manage this listing forever.',
    ...
    'sign.signButton': 'Sign & register on Base',
    ...
    'sign.viewTx': 'View register tx on Basescan',
  ...
  zh: {
    ...
    'home.pillar1.body': '每个商家通过 ERC-8004 锚定在 Base 链上。身份可验证、可迁移、自主掌控——没有平台能下架你。',
    ...
    'profile.wallet.viewChainscan': '在 Basescan 查看',
    ...
    'detail.error': '加载失败',
    'detail.badge.verified': '已上链 Base',
    ...
    'detail.viewRegisterTx': '在 Basescan 查看注册交易',
    'detail.onchain.footer': '锚定在 Base Sepolia 测试网 (chainId 84532)，通过 ERC-8004 IdentityRegistry 合约。',
    'detail.testSkills': '试用这些技能 →',

    // ─── AgentDemo page (main hero only) ───
    'demoPage.title': '个人 Agent 演示',
    'demoPage.subtitle': '用你自己的 API key，让 AI agent 跑在七牛 AIGC 模型上。',
    'demoPage.reset': '重置',
    ...
    'register.almostTitle.desc': '你的商家资料将被哈希并写入 Base。你需要用 Web3 钱包对交易进行签名。',
    'register.field.wallet': '钱包地址',
    'register.field.skills': '支持的技能（逗号分隔）',
    'register.field.skills.ph': 'get_menu,reserve_table,create_booking',
    'register.back': '上一步',
    'register.next': '下一步',
    'register.submit': '注册到 Base',
    'register.submitting.off': '正在保存商家资料…',
    'register.submitting.chain': '正在签名链上交易…',
    'register.success.title': '注册成功！',
    'register.success.desc': '你的商家资料已锚定到 Base。',
    'register.success.did': '链上 DID',
    'register.success.hash': '资料哈希 (SHA-256)',
    'register.success.tx': '链上交易',
    'register.success.viewExplorer': '在 Basescan 查看',
    'register.success.endpoint': '技能接入点',
    'register.success.again': '再注册一家',

    // ─── Agent demo page (chat UI) ───
    'demo.connectTitle': '连接到七牛 AIGC',
    'demo.connectBadge': '已连接七牛 · {network}',
    'demo.agentName': 'Concourse AI Agent',
    'demo.agentStatus.ready': 'Qiniu · {model}',
    'demo.agentStatus.notConnected': '未连接',
    'demo.empty.title': '填入 API key 以开始对话',
    'demo.empty.subtitle': '你的七牛 API key 为 AI 推理买单',
    // Provider label (七牛 API key)
    'demo.provider.zerog': '七牛 AIGC',
    ...
    'demo.greeting': '你好！我是你的 AI 旅行助手，由 **七牛 AIGC** 驱动，接入 **Concourse** 去中心化商家注册表。',
    ...
    'sign.subtitle': '你的 AI agent 已经拟好了商家资料。审查下方内容后，连接钱包签名并上链到 Base。一次签名后，agent 将长期代管这个商家。',
    'sign.loading': '正在加载草稿……',
